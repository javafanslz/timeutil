 ...
 */
public class StampToTimeButton implements ActionListener {

    private JTextField timeField;
    private JTextField timeStyle;
    private JTextField resultField;

    public StampToTimeButton(JTextField timeField, JTextField timeStyle, JTextField resultField){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(timeText == null||"".equals(timeText.trim())){
            ...
            String result = "";
            try{
             result = CommonUtils.stamp2Time(timeText,timeStyleText);
